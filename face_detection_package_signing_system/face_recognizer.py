...
class Face_Recognizer:
    ...
    def draw_note(self, img_rd):
        ...
        cv2.putText(img_rd, "S: sign for the package", (20, 400), font,
                    0.8, (255, 255, 255), 1, cv2.LINE_AA)
        cv2.putText(img_rd, "Q: Quit", (20, 450), font,
                    0.8, (255, 255, 255), 1, cv2.LINE_AA)
    ...
    def draw_name(self, img_rd):
        ...
        for i in range(self.faces_cnt):
            ...
            draw.text(
                xy=self.pos_camera_list[i], text=self.name_camera_list[i], font=font)
                    ...
                    if len(faces) != 0:
                        ...
                        for k in range(len(faces)):
                            ...
                            if min(e_distance_list) < 0.4:
                                ...
                                # self.person_id = similar_person_num
                                print(
                                    "May be person " + str(self.name_known_list[similar_person_num]))
                            else:
